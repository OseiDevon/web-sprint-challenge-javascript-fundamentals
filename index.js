...
// The nestedFuction has access to the variable internal because of the parent child relationship between the function. myFunction is the parent, and anything the parent function has the child function has access to.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    /*Your Code Here*/
    return zooAnimals.map(function(sooo){
      return sooo.animal_name.toLowerCase();
    })
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    /*Your Code Here*/
    return zooAnimals.filter(sooo => sooo.population < 5);
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    /*Your Code Here*/
    let slimfast = function(accumulator, animal){
      return accumulator + animal.population;
    }
    return zooAnimals.reduce(slimfast, 0)
  }
  ...
  */
  ...
  function consume(one, two, three){
    /*Your Code Here */
...
*/
function CuboidMaker(sauce){
  /*Your Code Here */
  this.length = sauce.length;
  this.width = sauce.width;
  this.height = sauce.height;
}
...
// function cuboid(sauce){
//   CuboidMaker.call(this, sauce)
// }
